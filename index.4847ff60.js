...
(parcelRequire("aKzDW")).register(JSON.parse('{"aykEV":"index.4847ff60.js","f1szL":"calendar-week-fill.f6a5fd4c.svg","ca24M":"calendar-week.8804ad50.svg"}'));
...
const $1e64527cd714425c$var$icons = {
    calenderWeek: {
        dark: new URL($1a30e11e72f9c8d4$exports).href,
        light: new URL($f4b97d8462087a84$exports).href
    }
};
...
TrelloPowerUp.initialize({
    ...
    "board-buttons": function(t, opts) {
        console.log(new URL($1a30e11e72f9c8d4$exports));
        return [
            {
...
//# sourceMappingURL=index.4847ff60.js.map
